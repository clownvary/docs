...
var Alert = function (_PureComponent) {
  ...
  Alert.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        rest = (0, _objectWithoutProperties3.default)(_props, ['className', 'style', 'type', 'noClose', 'inverse', 'onClose', 'children']);
    ...
    return _react2.default.createElement(
      'div',
      (0, _extends3.default)({}, rest, { className: classes, style: style, role: 'alert' }),
      _react2.default.createElement('span', { className: 'icon-' + icons[type] }),
      children,
      noClose ? undefined : _react2.default.createElement(
        'button',
...
Alert.propTypes = {
  type: (0, _propTypes.oneOf)(['success', 'warning', 'danger', 'error', 'info']).isRequired, // `error` is an alias for `danger`
