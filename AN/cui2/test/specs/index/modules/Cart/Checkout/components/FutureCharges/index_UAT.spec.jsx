...
describe('index/modules/Cart/Checkout/components/FutureCharges (UAT)', () => {
  it('It should have Future Charges section display when hideFutureCharges is false', () => {
    const { container } =
      setup(data, null, { hideFutureCharges: false });
    expect(container.length).toEqual(1);
  });

  it('It should not have Future Charges section display when hideFutureCharges is true', () => {
    const { container } =
