...
import ReceiptCode from 'index/modules/Cart/Confirmation/components/ReceiptTransaction';
...
describe('index/modules/Cart/Confirmation/components/ReceiptTransaction(UAT)', () => {
  describe('UAT Case: Inspect content shown on Receipt page shall be all correct.', () => {
