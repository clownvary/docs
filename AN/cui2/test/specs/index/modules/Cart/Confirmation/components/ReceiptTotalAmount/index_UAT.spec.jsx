...
describe('index/modules/Cart/Confirmation/components/ReceiptTotalAmount(UAT)', () => {
  describe('UAT Case: Inspect Receipt summary can show proper content as designed', () => {
