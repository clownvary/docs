...
import PropertyListMd from 'doc/api/components/PropertyList/index.md';
...
export default class Page extends DemoPage {
  ...
  static meta = {
    name: 'PropertyList',
    icon: 'icon-list',
    documents: [PropertyListMd],
    description: 'This example demonstrates the features of PropertyList.'
  }
  ...
  renderContent() {
    ...
    const className = classNames({ 'label-align-right': props.right }, { 'label-bold': props.bold });

    return (
      <Form title="PropertyList">
        <PropertyList
          {...props}
          className={className}
          items={items}
