...
var Popover = function Popover(_ref) {var _classNames;var className = _ref.className,style = _ref.style,direction = _ref.direction,theme = _ref.theme,children = _ref.children,rest = (0, _objectWithoutProperties3.default)(_ref, ['className', 'style', 'direction', 'theme', 'children']);
  var classes = (0, _classnames2.default)((_classNames = {

    popover: true }, (0, _defineProperty3.default)(_classNames, 'popover--' +
  direction, direction), (0, _defineProperty3.default)(_classNames, 't-' +
  theme, theme), _classNames),

  className);


  return (
    _react2.default.createElement('div', (0, _extends3.default)({ className: classes, style: style }, rest),
      children));
...
Popover.defaultProps = defaultProps;exports.default =

Popover;module.exports = exports['default'];