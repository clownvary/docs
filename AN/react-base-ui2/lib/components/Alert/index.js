...
_Alert2.default.success = function (props) {return (
    (0, _util.alert)((0, _extends3.default)({
      type: 'success' },
    wrapProps(props))));};


_Alert2.default.warning = function (props) {return (
    (0, _util.alert)((0, _extends3.default)({
      type: 'warning' },
    wrapProps(props))));};


_Alert2.default.error = function (props) {return (
    (0, _util.alert)((0, _extends3.default)({
      type: 'danger' },
    wrapProps(props))));};


_Alert2.default.info = function (props) {return (
    (0, _util.alert)((0, _extends3.default)({
      type: 'info' },
    wrapProps(props))));};


_Alert2.default.clear = function () {return (0, _util.clear)();};exports.default =

_Alert2.default;module.exports = exports['default'];